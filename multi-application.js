...
let MultiApplication = class MultiApplication extends LitElement {
    constructor() {
        super();
        this.min = 5;
        this.max = 110;
...
__decorate([
    property()
], MultiApplication.prototype, "state", void 0);
MultiApplication = __decorate([
